...
using Pankaj_code.Data;
using Pankaj_code.Filter;

namespace Pankaj_code.Controllers
{
    /// <summary>
    ...
    {
        private readonly Pankaj_codeContext _context;

        public OrderStatus2Controller(Pankaj_codeContext context)
        {
            _context = context;
        }
